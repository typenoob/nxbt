...
if __name__ == "__main__":
    ...
    vg_msg = (
        "    Please ensure that Vagrant is installed and available on\n"
        "    your system path."
    )
    ...
    print(
        "As part of the first step in this process, you will "
    ...
    while invalid_choice:
        ...
        if usb_choice.isdigit() and int(usb_choice) < len(devices):
            ...
            print(
                f"Invalid choice. Please choose a number from 0 to {len(devices) - 1}."
            )
